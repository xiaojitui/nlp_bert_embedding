...
def get_batch_seq_2(X_feature, doc_len, sen_len):
    batch_doc_id = []
    batch_doc_mask = []
...
def prepare_bert(bert_vocab_file, bert_config_file, init_checkpoint, sen_len, select_layers, graph_file):

    tokenizer = tokenization.FullTokenizer(bert_vocab_file)
    estimator = get_estimator(bert_config_file, init_checkpoint, sen_len, select_layers, graph_file)
